...
def grade_func2(file,step=0,outp=sys.stdout):
    """
    Returns the test result and score for the implementation of revrange
    ...
    function = 'revrange'
    testcase = [(0,3,(2,1,0)),(0,4,(3,2,1,0)),(-1,5,(4,3,2,1,0,-1)),
                (5,10,(9,8,7,6,5)),(3,4,(3,)),(3,3,())]
...
def grade_func1(file,step=0,outp=sys.stdout):
    ...
    function = 'factorial'
    testcase = [(0,1),(1,1),(2,2),(3,6),(4,24),(5,120),(6,720),(8,40320),(12,479001600)]
...
def grade_structure(file,func,step=0,outp=sys.stdout):
    ...
    for item in ast.walk(body):
        if type(item) == ast.For:
            ...
            found2 = True
        elif type(item) == ast.Call and item.func.id == func:
            found3 = True
