...
def grade_first(file,step=0,outp=sys.stdout):
    ...
    testcase = [('grrm',-1),('pat',1),('ask',0),('step',2),('eat',0),('strip',3),
                ('ice',0),('stop',2),('gloam',2),('soccer',1),('truck',2),('use',0),
                ('aeiuo',0),('ygglx',-1),('sky',2),('year',1),('bygone',1)]
...
def grade_piggy(file,step=0,outp=sys.stdout):
    ...
    for item in ast.walk(body):
        if type(item) == ast.If:
            found1 = True
        elif type(item) == ast.Call and item.func.id == 'first_vowel':
            found2 = True
