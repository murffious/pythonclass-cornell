...
def grade_func1(file,step=0,outp=sys.stdout):
    ...
    function = 'prod'
    testcase = range(1,10)
    testcase = [(5,5),(-2,-2),(1,),(1,2,3,1,6),(7,12,1,2,2,336),(7,12,0,2,2,0),
                (1,1,1,1,1),(1,-2,3,-4,24),(1,-2,3,4,-24)]
    ...
    for pair in testcase:
        ...
        try:
            ...
            if env.module.__depthguard__ <= 0:
                ...
                outp.write("The call %s(%s) returns %s, not %s.\n" % (function, repr(args), repr(received), repr(expected)))
                score -= 1/len(testcase)
                if not step:
                    return (FAIL_INCORRECT,max(0,score))
...
def grade_func2(file,step=0,outp=sys.stdout):
    ...
    testcase = [((5,),5,4,(4,)),
                ...
                ((1,2,3,1), 1, 4,(4,2,3,4)),
                ((1,2,3,1), 4, 1,(1,2,3,1)),
                ((5, 3, 355, 74, 74, 74, 3),3,20,(5, 20, 355, 74, 74, 74, 20)),
                ((5, 3, 355, 74, 74, 74, 3),74,3,(5, 3, 355, 3, 3, 3, 3))]
